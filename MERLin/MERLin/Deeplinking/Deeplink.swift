...
public protocol Deeplinkable: DeeplinkResponder {
    ...
    /// This method can override the presentation mode of the deeplink from push to modal.
    /// by returning false the default implementation of the router will infer the preference of this
    /// module to be modal only, and will respect it.
    ///
    /// - parameter viewController: The view ocntroller that is going to be pushed.
    /// This VC is generated by the module.
    /// - parameter deeplink: The deeplink that generated the view controller.
    /// - returns: a boolean value that indicates if this controller can be pushed in a navigation
    /// controller, or if it must be presented.
