...
public extension UILabel {
    public func applyLabelStyle(_ style: ThemeFontStyle, usingTheme theme: ModuleThemeProtocol = Module.defaultTheme, customizing: ((UILabel, ModuleThemeProtocol)->Void)? = nil) {
