...
public extension NSAttributedString {
    public static func attributedString(withString string: String, andStyle style: ThemeFontStyle, usingTheme theme: ModuleThemeProtocol = Module.defaultTheme) -> NSAttributedString {
        return theme.attributedString(withString: string, andStyle: style)
    }
    
    public static func attributedString(fromHTML string: String, andStyle style: ThemeFontStyle, usingTheme theme: ModuleThemeProtocol = Module.defaultTheme) -> NSAttributedString {
    ...
    public func applyStyle(_ style: ThemeFontStyle, andColor color: ThemeColorPalette, toRange range: NSRange, usingTheme theme: ModuleThemeProtocol = Module.defaultTheme) -> NSAttributedString {
